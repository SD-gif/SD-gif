...
> 기본에 충실하고, 깔끔한 코드를 지향하는 백엔드 개발자입니다.  
> 읽기 쉬운 코드와 명확한 구조를 통해 유지보수성을 높이는 것을 중요하게 생각합니다.
...
| 프로젝트 | 설명 | 기술 스택 | 링크 |
|---------|------|-----------|------|
| **프로젝트명 1** | 프로젝트 한 줄 설명 | Java, Spring Boot, MySQL | [🔗 GitHub](https://github.com/SD-gif) |
| **프로젝트명 2** | 프로젝트 한 줄 설명 | Java, Spring Security, JWT | [🔗 GitHub](https://github.com/SD-gif) |

> 프로젝트명과 설명, 링크를 실제 내용으로 교체해주세요.
